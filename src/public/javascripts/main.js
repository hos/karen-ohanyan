...
function nextImage () {
  ...
  var newLink = window.location.href.replace(
    currentImage.fileName.replace('.jpg', ''),
    nextImage.fileName.replace('.jpg', '')
  )
...
function previousImage () {
  ...
  var newLink = window.location.href.replace(
    currentImage.fileName.replace('.jpg', ''),
    prevImage.fileName.replace('.jpg', '')
  )
  window.location.replace(newLink)
}
...
function matchAndMarkSelectedPage () {
  ...
  var currentItem = links.find(function (a) {
    var currentHref = a.href.replace(
